...
@section('js')
            ...
            fields: [
                ...
                },
                {
                    ...
                    itemTemplate: function(value, item) {
                        return '<a href="'+item.file+'">Unduh</a>';
                    }
                },
                {
                    name: "description",
    ...
    {
        window.location.href = "{{route('logbook.edit')}}"+"/"+itemedit.id;
    }

    function modal_add(){
        window.location = "{{route('logbook.modal',$id)}}";
    }
    </script>
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="card">
                ...
                <div class="col-12">
                    <a href="{{route('internship_students.index')}}" class="btn btn-xs btn-primary"><i class="fas fa-angle-left"></i> Kembali</a>
                    </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">

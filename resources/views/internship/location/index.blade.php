...
@section('js')
        ...
        $("#jsGrid").jsGrid({
            ...
            controller: {
                loadData: function(filter) {
                    return $.ajax({
                        type: "GET",
                        url: "{{route('internship_locations.show')}}",
                        data: filter
                    });
                },
                ...
                deleteItem: function(item) {
                    return $.ajax({
                        type: "DELETE",
                        url: "{{route('internship_locations.destroy')}}",
                        data: item
            ...
            fields: [
                ...
                },
                {
                    ...
                    itemTemplate: function(value, item) {
                        return '<a href="'+item.legal_file+'">Unduh</a>';
                    }
                },
                {
                    type: "control",
    ...
    {
        window.location.href = "{{route('internship_locations.edit')}}"+"/"+itemedit.id;
    }

    function modal_add(){
        window.location = "{{route('internship_locations.modal')}}";
    }
    </script>
@endsection

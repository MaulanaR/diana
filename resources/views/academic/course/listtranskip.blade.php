            ...
            fields: [
                ...
                },
                {
                    ...
                    itemTemplate: function(value, item) {
                        ...
                        var eButton = '';
                        var dButton = '';
                            eButton += '<button type="button" class="btn btn-sm btn-outline-primary text-left" title="CetakGanjil"><i class="fas fa-book"></i> Cetak Transkrip</button>'
                        ...
                        let editDeleteBtn = $(startDiv+eButton+dButton+endDiv)
                            .on('click', function (e) {
                                if (e.target.title == 'CetakGanjil') {
                                    e.stopPropagation();
                                    window.location.href = "{{route('transkip.cetak')}}"+"/"+item.class_academic_period_id+"/"+item.class_id+"/"+item.student_id+"/1";
                                }
                            });
